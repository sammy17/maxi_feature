...
set id 1
set name feature_mux_10to1_sel32_16_1
...
# Memory (RAM/ROM)  definition:
set ID 3
set MemName feature_featureHist_0
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 512
...
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'M_OFFSET'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler feature_M_OFFSET_m_axi
}
