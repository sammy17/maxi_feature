...
set ID 19
set MemName feature_featureHist_memcore
...
# FIFO definition:
set ID 20
set FifoName FIFO_feature_frame_in_channel
...
# FIFO definition:
set ID 21
set FifoName FIFO_feature_featureh_channel
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 22
set FifoName FIFO_feature_boundingBoxes_3_loc_channel
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 23
set FifoName FIFO_feature_boundingBoxes_2_loc_channel
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 24
set FifoName FIFO_feature_boundingBoxes_1_loc_channel
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 25
set FifoName FIFO_feature_boundingBoxes_0_loc_channel
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler feature_AXILiteS_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler feature_CRTL_BUS_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler feature_gmem_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler feature_gmem_offset_m_axi
}
