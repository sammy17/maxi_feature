...
set C_modelArgList { 
	...
	{ CRTL_BUS int 16 regular {axi_master 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "frame_in","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "frame_in","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 38399,"step" : 1}]}]}]} , 
 	{ "Name" : "CRTL_BUS", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "bounding","cData": "unsigned short","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "bounding","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]},{"cName": "featureh","cData": "unsigned short","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "featureh","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ m_axi_CRTL_BUS_AWVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_AWREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_AWADDR sc_out sc_lv 32 signal 1 } 
	{ m_axi_CRTL_BUS_AWID sc_out sc_lv 1 signal 1 } 
	{ m_axi_CRTL_BUS_AWLEN sc_out sc_lv 8 signal 1 } 
	{ m_axi_CRTL_BUS_AWSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_CRTL_BUS_AWBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_CRTL_BUS_AWLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_CRTL_BUS_AWCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_CRTL_BUS_AWPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_CRTL_BUS_AWQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_CRTL_BUS_AWREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_CRTL_BUS_AWUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_CRTL_BUS_WVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_WREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_WDATA sc_out sc_lv 32 signal 1 } 
	{ m_axi_CRTL_BUS_WSTRB sc_out sc_lv 4 signal 1 } 
	{ m_axi_CRTL_BUS_WLAST sc_out sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_WID sc_out sc_lv 1 signal 1 } 
	{ m_axi_CRTL_BUS_WUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_CRTL_BUS_ARVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_ARREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_ARADDR sc_out sc_lv 32 signal 1 } 
	{ m_axi_CRTL_BUS_ARID sc_out sc_lv 1 signal 1 } 
	{ m_axi_CRTL_BUS_ARLEN sc_out sc_lv 8 signal 1 } 
	{ m_axi_CRTL_BUS_ARSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_CRTL_BUS_ARBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_CRTL_BUS_ARLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_CRTL_BUS_ARCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_CRTL_BUS_ARPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_CRTL_BUS_ARQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_CRTL_BUS_ARREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_CRTL_BUS_ARUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_CRTL_BUS_RVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_RREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_RDATA sc_in sc_lv 32 signal 1 } 
	{ m_axi_CRTL_BUS_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_CRTL_BUS_RUSER sc_in sc_lv 1 signal 1 } 
	{ m_axi_CRTL_BUS_RRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_CRTL_BUS_BVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_BREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_CRTL_BUS_BRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_CRTL_BUS_BID sc_in sc_lv 1 signal 1 } 
	{ m_axi_CRTL_BUS_BUSER sc_in sc_lv 1 signal 1 } 
