...
feature_M_OFFSET_m_axi_throttl #(
    .USED_FIX(0)
) wreq_throttl (
    .clk(ACLK),
    .reset(ARESET),
...
module feature_M_OFFSET_m_axi_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module feature_M_OFFSET_m_axi_decoder
#(parameter
    DIN_WIDTH       = 3
)(
...
module feature_M_OFFSET_m_axi_throttl
#(parameter
    USED_FIX       = 0,
    FIX_VALUE      = 4
)(
...
module feature_M_OFFSET_m_axi_read
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
    C_M_AXI_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
module feature_M_OFFSET_m_axi_write
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
    C_M_AXI_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------Body---------------------------
    ...
    if (USER_DATA_WIDTH == BUS_DATA_WIDTH) begin : bus_equal_gen
        ...
        feature_M_OFFSET_m_axi_decoder #(
            .DIN_WIDTH(PAD_ALIGN)
        ) head_pad_decoder (
            .din(head_pads),
            .dout(head_pad_sel));
