...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_CRTL_BUS m_axi_gmem m_axi_CRTL_BUS"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_CRTL_BUS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_CRTL_BUS"
        data_width "32"
        param_prefix "C_M_AXI_CRTL_BUS"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 1497978 II x}
...
set enable_xo_gen 0
set kernel_files {F:/maxi/feature_maxi/feature.cpp}
if {$enable_xo_gen} {
