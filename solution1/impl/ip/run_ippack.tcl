...
set IPName      "feature"
set Version     "1.0"
set DisplayName "Feature"
set Revision    "1712281615"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 frame_in W 0x0 "Data signal of frame_in" {{0 32 frame_in W 0 "Bit 31 to 0 Data signal of frame_in"}}} {0x18 bounding W 0x0 "Data signal of bounding" {{0 32 bounding W 0 "Bit 31 to 0 Data signal of bounding"}}} {0x20 featureh W 0x0 "Data signal of featureh" {{0 32 featureh W 0 "Bit 31 to 0 Data signal of featureh"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_CRTL_BUS m_axi_M_OFFSET"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_M_OFFSET {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_M_OFFSET"
        data_width "32"
        param_prefix "C_M_AXI_M_OFFSET"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 1387618 II x}
...
set enable_xo_gen 0
set kernel_files {/home/zynq-fyp/Desktop/maxi_latest/maxi_feature/feature.cpp}
if {$enable_xo_gen} {
