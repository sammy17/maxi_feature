...
architecture behav of feature_Loop_memcpy_boundingBoxes_boun is 
    ...
    signal exitcond_i_i_i_reg_323 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ap_reg_ppstg_exitcond_i_i_i_reg_323_pp0_it1 : STD_LOGIC_VECTOR (0 downto 0);
    signal indvar_next_i_i_i_fu_210_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_12_fu_216_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_12_reg_332 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_reg_ppstg_tmp_12_reg_332_pp0_it1 : STD_LOGIC_VECTOR (1 downto 0);
    signal boundingBoxes_0_reg_339 : STD_LOGIC_VECTOR (15 downto 0);
    signal boundingBoxes_3_fu_248_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal boundingBoxes_3_1_fu_263_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal boundingBoxes_3_4_fu_278_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal boundingBoxes_3_6_fu_286_p3 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal newSel4_i_i_fu_241_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal newSel_i_i_fu_256_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal boundingBoxes_3_3_fu_271_p3 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_7) and not((ap_sig_bdd_142 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_lv1_0 = exitcond_i_i_i_fu_204_p2)))) then 
                    ap_reg_ppiten_pp0_it0 <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6) and not(ap_sig_bdd_186))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6) and not(ap_sig_bdd_186)) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_7) and not((ap_sig_bdd_142 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and not((ap_const_lv1_0 = exitcond_i_i_i_fu_204_p2))))) then 
                    ap_reg_ppiten_pp0_it1 <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_7) and (ap_const_lv1_0 = exitcond_i_i_i_reg_323) and not((ap_sig_bdd_142 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and not((ap_sig_bdd_142 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond_i_i_i_reg_323_pp0_it1))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_sig_bdd_122, ap_sig_ioackin_m_axi_bounding_ARREADY, exitcond_i_i_i_fu_204_p2, ap_reg_ppiten_pp0_it0, ap_sig_bdd_142, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it2, ap_sig_bdd_186)
    begin
        case ap_CS_fsm is
    ...
    ap_sig_bdd_142_assign_proc : process(m_axi_bounding_RVALID, exitcond_i_i_i_reg_323)
    begin
                ap_sig_bdd_142 <= ((m_axi_bounding_RVALID = ap_const_logic_0) and (ap_const_lv1_0 = exitcond_i_i_i_reg_323));
    end process;
    ...
    ap_sig_bdd_186_assign_proc : process(frame_in_out_full_n, featureh_out_full_n)
    begin
                ap_sig_bdd_186 <= ((frame_in_out_full_n = ap_const_logic_0) or (featureh_out_full_n = ap_const_logic_0));
    end process;
    ...
    ap_sig_bdd_371_assign_proc : process(m_axi_bounding_ARREADY, ap_sig_bdd_122)
    begin
                ap_sig_bdd_371 <= ((ap_const_logic_1 = m_axi_bounding_ARREADY) and not(ap_sig_bdd_122));
    end process;
    ...
    ap_sig_cseq_ST_st11_fsm_8_assign_proc : process(ap_sig_bdd_280)
    begin
    ...
    ap_sig_cseq_ST_st7_fsm_6_assign_proc : process(ap_sig_bdd_181)
    begin
    ...
    boundingBoxes_3_1_fu_263_p3 <= 
        boundingBoxes_2_out_i_i_reg_136 when (or_cond_i_i_fu_235_p2(0) = '1') else 
        newSel_i_i_fu_256_p3;
    boundingBoxes_3_3_fu_271_p3 <= 
        boundingBoxes_0_reg_339 when (sel_tmp2_i_i_fu_225_p2(0) = '1') else 
        boundingBoxes_3_2_reg_148;
    boundingBoxes_3_4_fu_278_p3 <= 
        boundingBoxes_3_2_reg_148 when (sel_tmp4_i_i_fu_230_p2(0) = '1') else 
        boundingBoxes_3_3_fu_271_p3;
    boundingBoxes_3_6_fu_286_p3 <= 
        boundingBoxes_0_reg_339 when (sel_tmp4_i_i_fu_230_p2(0) = '1') else 
        boundingBoxes_3_5_reg_160;
    boundingBoxes_3_fu_248_p3 <= 
        boundingBoxes_3_out_i_i_reg_124 when (or_cond_i_i_fu_235_p2(0) = '1') else 
        newSel4_i_i_fu_241_p3;
    ...
    featureh_out_write_assign_proc : process(ap_sig_cseq_ST_st7_fsm_6, ap_sig_bdd_186)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6) and not(ap_sig_bdd_186))) then 
    ...
    frame_in_out_write_assign_proc : process(ap_sig_cseq_ST_st7_fsm_6, ap_sig_bdd_186)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6) and not(ap_sig_bdd_186))) then 
    ...
    m_axi_bounding_RREADY_assign_proc : process(exitcond_i_i_i_reg_323, ap_sig_cseq_ST_pp0_stg0_fsm_7, ap_sig_bdd_142, ap_reg_ppiten_pp0_it1)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_7) and (ap_const_lv1_0 = exitcond_i_i_i_reg_323) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and not((ap_sig_bdd_142 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1))))) then 
    ...
    newSel4_i_i_fu_241_p3 <= 
        boundingBoxes_3_out_i_i_reg_124 when (sel_tmp_i_i_fu_220_p2(0) = '1') else 
        boundingBoxes_0_reg_339;
    newSel_i_i_fu_256_p3 <= 
        boundingBoxes_0_reg_339 when (sel_tmp_i_i_fu_220_p2(0) = '1') else 
        boundingBoxes_2_out_i_i_reg_136;
    or_cond_i_i_fu_235_p2 <= (sel_tmp4_i_i_fu_230_p2 or sel_tmp2_i_i_fu_225_p2);
    sel_tmp2_i_i_fu_225_p2 <= "1" when (ap_reg_ppstg_tmp_12_reg_332_pp0_it1 = ap_const_lv2_1) else "0";
    sel_tmp4_i_i_fu_230_p2 <= "1" when (ap_reg_ppstg_tmp_12_reg_332_pp0_it1 = ap_const_lv2_0) else "0";
    sel_tmp_i_i_fu_220_p2 <= "1" when (ap_reg_ppstg_tmp_12_reg_332_pp0_it1 = ap_const_lv2_2) else "0";
