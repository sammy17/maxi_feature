...
feature_featureHist::~feature_featureHist() {
...
void feature_featureHist::proc_i_full_n() {
    i_full_n.write(full_n.read());
}

void feature_featureHist::proc_t_empty_n() {
    t_empty_n.write(empty_n.read());
}

void feature_featureHist::proc_i_q0() {
    i_q0.write(buf_q0[iptr.read()].read());
}

void feature_featureHist::proc_t_q0() {
    t_q0.write(buf_q0[tptr.read()].read());
}

void feature_featureHist::proc_i_q1() {
    i_q1.write(buf_q1[iptr.read()].read());
}

void feature_featureHist::proc_t_q1() {
    t_q1.write(buf_q1[tptr.read()].read());
}

void feature_featureHist::proc_buffer_signals() {
    for (unsigned i = 0; i < BufferCount; i++) {
        if (iptr.read() == i) {
...
void feature_featureHist::proc_push_buf() {
    push_buf.write(i_ce.read() & i_write.read() & full_n.read());
}

void feature_featureHist::proc_pop_buf() {
    pop_buf.write(t_ce.read() & t_read.read() & empty_n.read());
}

void feature_featureHist::proc_iptr() {
...
void feature_featureHist::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void feature_featureHist::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void feature_featureHist::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void feature_featureHist::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
