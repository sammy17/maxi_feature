...
$(ObjDir)/test.cpp_pre.o : test.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/feature.cpp_pre.o : feature.cpp_pre.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling feature.cpp_pre.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
