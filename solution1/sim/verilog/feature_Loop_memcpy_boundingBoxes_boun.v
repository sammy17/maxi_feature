...
reg   [0:0] exitcond_i_i_i_reg_316;
...
reg   [0:0] ap_reg_ppstg_exitcond_i_i_i_reg_316_pp0_it1;
wire   [2:0] indvar_next_i_i_i_fu_210_p2;
wire   [1:0] tmp_12_fu_216_p1;
reg   [1:0] tmp_12_reg_325;
reg   [15:0] boundingBoxes_0_reg_332;
wire   [0:0] sel_tmp_i_i_fu_220_p2;
reg   [0:0] sel_tmp_i_i_reg_340;
wire   [0:0] sel_tmp2_i_i_fu_225_p2;
reg   [0:0] sel_tmp2_i_i_reg_346;
wire   [0:0] sel_tmp4_i_i_fu_230_p2;
reg   [0:0] sel_tmp4_i_i_reg_352;
wire   [15:0] boundingBoxes_3_fu_245_p3;
wire   [15:0] boundingBoxes_3_1_fu_259_p3;
wire   [15:0] boundingBoxes_3_4_fu_273_p3;
wire   [15:0] boundingBoxes_3_6_fu_280_p3;
...
wire   [15:0] newSel4_i_i_fu_239_p3;
wire   [15:0] newSel_i_i_fu_253_p3;
wire   [15:0] boundingBoxes_3_3_fu_267_p3;
...
always @ (posedge ap_clk) begin : ap_ret_ap_reg_ppiten_pp0_it0
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_7) & ~(ap_sig_bdd_142 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)) & ~(ap_const_lv1_0 == exitcond_i_i_i_fu_204_p2))) begin
            ap_reg_ppiten_pp0_it0 <= ap_const_logic_0;
        end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st7_fsm_6) & ~ap_sig_bdd_190)) begin
...
always @ (posedge ap_clk) begin : ap_ret_ap_reg_ppiten_pp0_it1
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((ap_const_logic_1 == ap_sig_cseq_ST_st7_fsm_6) & ~ap_sig_bdd_190) | ((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_7) & ~(ap_sig_bdd_142 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)) & ~(ap_const_lv1_0 == exitcond_i_i_i_fu_204_p2)))) begin
            ap_reg_ppiten_pp0_it1 <= ap_const_logic_0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_7) & (ap_const_lv1_0 == exitcond_i_i_i_reg_316) & ~(ap_sig_bdd_142 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_reg_ppiten_pp0_it2) & ~(ap_sig_bdd_142 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)) & (ap_const_lv1_0 == ap_reg_ppstg_exitcond_i_i_i_reg_316_pp0_it1))) begin
...
always @ (ap_sig_cseq_ST_st7_fsm_6 or ap_sig_bdd_190) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st7_fsm_6) & ~ap_sig_bdd_190)) begin
...
always @ (exitcond_i_i_i_reg_316 or ap_sig_cseq_ST_pp0_stg0_fsm_7 or ap_sig_bdd_142 or ap_reg_ppiten_pp0_it1) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_7) & (ap_const_lv1_0 == exitcond_i_i_i_reg_316) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & ~(ap_sig_bdd_142 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)))) begin
        m_axi_bounding_RREADY = ap_const_logic_1;
    end else begin
        m_axi_bounding_RREADY = ap_const_logic_0;
    end
end
always @ (ap_CS_fsm or ap_sig_bdd_122 or ap_sig_ioackin_m_axi_bounding_ARREADY or exitcond_i_i_i_fu_204_p2 or ap_reg_ppiten_pp0_it0 or ap_sig_bdd_142 or ap_reg_ppiten_pp0_it1 or ap_reg_ppiten_pp0_it2 or ap_sig_bdd_190) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
            if (~(ap_sig_bdd_122 | (ap_const_logic_0 == ap_sig_ioackin_m_axi_bounding_ARREADY))) begin
...
always @ (m_axi_bounding_RVALID or exitcond_i_i_i_reg_316) begin
    ap_sig_bdd_142 = ((m_axi_bounding_RVALID == ap_const_logic_0) & (ap_const_lv1_0 == exitcond_i_i_i_reg_316));
end
...
always @ (frame_in_out_full_n or featureh_out_full_n) begin
    ap_sig_bdd_190 = ((frame_in_out_full_n == ap_const_logic_0) | (featureh_out_full_n == ap_const_logic_0));
end
...
always @ (m_axi_bounding_ARREADY or ap_sig_bdd_122) begin
    ap_sig_bdd_372 = ((ap_const_logic_1 == m_axi_bounding_ARREADY) & ~ap_sig_bdd_122);
end

assign boundingBoxes_3_1_fu_259_p3 = ((or_cond_i_i_fu_235_p2[0:0] === 1'b1) ? boundingBoxes_2_out_i_i_reg_136 : newSel_i_i_fu_253_p3);

assign boundingBoxes_3_3_fu_267_p3 = ((sel_tmp2_i_i_reg_346[0:0] === 1'b1) ? boundingBoxes_0_reg_332 : boundingBoxes_3_2_reg_148);

assign boundingBoxes_3_4_fu_273_p3 = ((sel_tmp4_i_i_reg_352[0:0] === 1'b1) ? boundingBoxes_3_2_reg_148 : boundingBoxes_3_3_fu_267_p3);

assign boundingBoxes_3_6_fu_280_p3 = ((sel_tmp4_i_i_reg_352[0:0] === 1'b1) ? boundingBoxes_0_reg_332 : boundingBoxes_3_5_reg_160);

assign boundingBoxes_3_fu_245_p3 = ((or_cond_i_i_fu_235_p2[0:0] === 1'b1) ? boundingBoxes_3_out_i_i_reg_124 : newSel4_i_i_fu_239_p3);
...
assign newSel4_i_i_fu_239_p3 = ((sel_tmp_i_i_reg_340[0:0] === 1'b1) ? boundingBoxes_3_out_i_i_reg_124 : boundingBoxes_0_reg_332);

assign newSel_i_i_fu_253_p3 = ((sel_tmp_i_i_reg_340[0:0] === 1'b1) ? boundingBoxes_0_reg_332 : boundingBoxes_2_out_i_i_reg_136);

assign or_cond_i_i_fu_235_p2 = (sel_tmp4_i_i_reg_352 | sel_tmp2_i_i_reg_346);

assign sel_tmp2_i_i_fu_225_p2 = (tmp_12_reg_325 == ap_const_lv2_1? 1'b1: 1'b0);

assign sel_tmp4_i_i_fu_230_p2 = (tmp_12_reg_325 == ap_const_lv2_0? 1'b1: 1'b0);

assign sel_tmp_i_i_fu_220_p2 = (tmp_12_reg_325 == ap_const_lv2_2? 1'b1: 1'b0);
