...
HLS_SOURCES = ../../../test.cpp ../../../feature.cpp
...
$(ObjDir)/feature.o: ../../../feature.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../feature.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD    $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/feature.d
